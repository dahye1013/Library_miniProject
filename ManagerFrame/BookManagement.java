...
public class BookManagement extends JPanel implements ActionListener {
	private JButton searchBtn, updateBtn, insertBtn, deleteBtn;
	...
	public BookManagement() {
		...
		// 라벨 생성
		titleL = new JLabel("Book Management");
		titleL.setFont(new Font("고딕체", Font.BOLD, 20));
		titleL.setForeground(new Color(255,0,0,0));
		...
		p5.add(deleteBtn);
		p5.add(updateBtn);
		p5.setForeground(new Color(255,0,0,0));
		pp45 = new JPanel();
		...
		p.add("Center", p3);
		p.add("South", pp45);
		p.setForeground(new Color(255,0,0,0));
	...
	public void actionPerformed(ActionEvent e) {
		...
		// JOptionPane.showMessageDialog(this, "대여가 완료되었습니다", "대여 완료",
