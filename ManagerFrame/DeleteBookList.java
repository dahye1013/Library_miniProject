...
public class DeleteBookList extends JPanel implements ActionListener, KeyListener {
	...
	private JTextField searchT, codeT, titleT, authorT, genreT, publisherT;
	private JLabel labelL, codeL, titleL, authorL, genreL, publisherL;
	...
	public void output() {
		...
		for (DeleteDTO deleteDTO : list) {
			Vector<String> v = new Vector<String>();
			v.add(deleteDTO.getCode() + ""); // ----------------------------------------0515수정, code로 변수명 수정
