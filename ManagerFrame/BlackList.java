...
public class BlackList extends JPanel implements ActionListener{
	...
	private LendDAO lendDAO = new LendDAO();// 0515추가
	public List<LendDTO> list = new ArrayList<LendDTO>();// 0515추가
	public static int overCount;//=========0518.sj
...
//					overCount = list.get(BookReport.nowMon-1).getOverCount();
//					overCount++;
//					reportDAO.updateReport(BookReport.nowMon);
				}
			}																										
		}
//		for (LendDTO dto : list) {
