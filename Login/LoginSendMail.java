...
public class LoginSendMail {
	...
	public void findIdMail(/*String email*/) {//파라미터 다른 오버로드 생성자들로 바꿀건지 고민
		//파라미터로 받아오면 지울부분!
	      ...
	      code =new String(""+ ranChar1 +ranChar2 +ranNum1 +ranNum2 + ranChar3+ranNum3 +ranChar4 +ranNum4 );
	        ...
	        String password = "bitbook522";   // 패스워드
	        ...
	        try {
	            ...
	            // Subject
	            message.setSubject("아이디 찾기 인증번호 안내"); //메일 제목을 입력

	            // Text
	            message.setText("아이디 찾기 인증번호는"+code+"입니다 ");    //메일 내용을 입력
	...
	public void findPWMail(String id,String email,String getPassword) {
	        ...
	        try {
	            ...
	            // Subject
	            message.setSubject("비트도서관 비밀번호 찾기  안내"); //메일 제목을 입력

	            // Text
	            message.setText(id+"님의 비밀번호는 "+getPassword+"입니다 ");    //메일 내용을 입력
